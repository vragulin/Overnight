...
def main():
	...
	bad_data = ['GEF', 'SPR', 'CBRL', 'HZNP', 'WTM', 'TEL',
	            'EMN', 'LVLT', 'SIX']  # bad share count data or other obvious issues, earlier version also had 'YELL'
	bad_corp_act = ['KSU', 'SSP', 'WFRD']  # incorrect representation of corporate actions
	free_float_adj = ['GOOG']
